...
namespace ProjectKawaiiCafeOrderingSystem {
    ...
    public partial class ReceiptDataSet : global::System.Data.DataSet {
        ...
        public partial class ReceiptDataTable : global::System.Data.TypedTableBase<ReceiptRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ReceiptRow AddReceiptRow(string Item_Name, int Quantity, decimal _Price_RM_) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ReceiptRow FindByItem_Name(string Item_Name) {
            ...
            private void InitClass() {
                ...
                this._columnPrice_RM_.AllowDBNull = false;
            }
        ...
        public partial class ReceiptRow : global::System.Data.DataRow {
            ...
            public decimal _Price_RM_ {
                get {
                    return ((decimal)(this[this.tableReceipt._Price_RM_Column]));
                }
                set {
                    this[this.tableReceipt._Price_RM_Column] = value;
                }
            }
        }
...
namespace ProjectKawaiiCafeOrderingSystem.ReceiptDataSetTableAdapters {
    ...
    public partial class ReceiptTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Receipt] WHERE (([Item Name] = @Original_Item_Name) AND ([Quan" +
                "tity] = @Original_Quantity) AND ([Price(RM)] = @p2))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Receipt] ([Item Name], [Quantity], [Price(RM)]) VALUES (@Item_" +
                "Name, @Quantity, @p1);\r\nSELECT [Item Name], Quantity, [Price(RM)] FROM Receipt W" +
                "HERE ([Item Name] = @Item_Name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Receipt] SET [Item Name] = @Item_Name, [Quantity] = @Quantity, [Price(RM)] = @p1 WHERE (([Item Name] = @Original_Item_Name) AND ([Quantity] = @Original_Quantity) AND ([Price(RM)] = @p2));
SELECT [Item Name], Quantity, [Price(RM)] FROM Receipt WHERE ([Item Name] = @Item_Name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjectKawaiiCafeOrderingSystem.Properties.Settings.Default.OrderItemsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Item Name], Quantity, [Price(RM)] FROM dbo.Receipt";
        ...
        public virtual int Delete(string Original_Item_Name, int Original_Quantity, decimal p2) {
        ...
        public virtual int Insert(string Item_Name, int Quantity, decimal p1) {
            if ((Item_Name == null)) {
        ...
        public virtual int Update(string Item_Name, int Quantity, decimal p1, string Original_Item_Name, int Original_Quantity, decimal p2) {
            if ((Item_Name == null)) {
                throw new global::System.ArgumentNullException("Item_Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Quantity, decimal p1, string Original_Item_Name, int Original_Quantity, decimal p2) {
            return this.Update(Original_Item_Name, Quantity, p1, Original_Item_Name, Original_Quantity, p2);
        }
    }
